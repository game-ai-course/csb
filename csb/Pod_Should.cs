...
namespace CG.CodersStrikeBack
{
    ...
    public class Pod_Should
    {
        ...
        [TestCase("10844 2983 241 -222 247 2", "9400 3000 100", "11019 2686 148 -252 229 2")]
        [TestCase("10030 2317 7 128 35 2", "11400 3000 100", "10126 2490 81 147 26 2")]
        [TestCase("1264 3490 -147 -522 291 1", "2000 3000 100", "1180 2890 -71 -510 309 1")]
